...
void htd4(dt *X,long a,long b,long c,long d,int *k,cublasHandle_t handle,cusolverDnHandle_t cusolverH)
{
  ...
  cudaDeviceSynchronize();
   ...
   cudaDeviceSynchronize();
   cudaFree(d_sumXXT);
   //cout<<"++++"<<endl;printTensor(d_Ux4,4,4,1,1);
...
//=======================用rsvd来做======================================
  ...
  cudaDeviceSynchronize();
  //printTensor(d_Ux3,4,4,1,1);
  cudaFree(d_U);
  cudaFree(d_XT);
//====================================================================
  half *h_Ux2,*h_Ux3,*h_Ux4,*h_Ux5,*h_Ux6,*h_Ux7;
    cudaMalloc((void**)&h_Ux7,sizeof(half)*d*k[6]); f2h(d_Ux7,h_Ux7,d*k[6]);
    cudaMalloc((void**)&h_Ux6,sizeof(half)*c*k[5]); f2h(d_Ux6,h_Ux6,c*k[5]);
    cudaMalloc((void**)&h_Ux5,sizeof(half)*b*k[4]); f2h(d_Ux5,h_Ux5,b*k[4]);
    cudaMalloc((void**)&h_Ux4,sizeof(half)*a*k[3]); f2h(d_Ux4,h_Ux4,a*k[3]);
    cudaMalloc((void**)&h_Ux3,sizeof(half)*c*d*k[2]); f2h(d_Ux3,h_Ux3,c*d*k[2]);
    cudaMalloc((void**)&h_Ux2,sizeof(half)*a*b*k[1]); f2h(d_Ux2,h_Ux2,a*b*k[1]);
