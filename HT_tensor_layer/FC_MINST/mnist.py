...
batch_size = 128
trainset = torchvision.datasets.MNIST(root='/root/huanghao/data', train=True, download=True, transform=transform_train)
...
testset = torchvision.datasets.MNIST(root='/root/huanghao/data', train=False, download=True, transform=transform_test)
